...
class AppStateNotifier extends ChangeNotifier {
  FunchatFirebaseUser? initialUser;
  FunchatFirebaseUser? user;
  ...
  void update(FunchatFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'usersScreen')
                  : UsersScreenWidget(),
            ),
            FFRoute(
              name: 'HomePage',
            ...
            FFRoute(
              ...
              path: 'inviteFriendPage',
              asyncParams: {
                'chat': getDoc('chats', ChatsRecord.serializer),
              },
              builder: (context, params) => InviteFriendPageWidget(
            ...
            FFRoute(
              name: 'chatHomeScreen',
              path: 'chatHomeScreen',
              builder: (context, params) => ChatHomeScreenWidget(),
            )
